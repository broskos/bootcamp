...
# kcli list vm
cp /opt/dnsmasq/include.d/sno2.ipv4 /opt/dnsmasq/include.d/sno2w.ipv4
sed -i s/sno2/sno3/g /opt/dnsmasq/include.d/sno2w.ipv4
sed -i "s/ocp-sno2w,192.168.125.40/ocp-sno2w,192.168.125.41/g" sno2w.ipv4 
# If adding new node: 
